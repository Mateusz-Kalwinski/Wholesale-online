...
ini_set('upload-tmp-dir', dirname(__FILE__).'/images/temp');
session_name('admin');
...
{ 
    ...
    curl_close($ch);
   //zwraca date z check_license.php
    return $result; 
}
...
elseif($curl !== '1'){
    ...
    if(!empty($_SESSION['id'])){
        if($_SERVER['REDIRECT_URL'] === '/admin/login'){
...
if(isset($_SESSION['id']) and !empty($_SESSION['id']))
{
    ...
    if($_SERVER['REDIRECT_URL']!== '/admin/login' && substr($_SERVER['REDIRECT_URL'],0,6)!== '/admin/reset'){
