             ...
             <div class="content-title">
                ...
                <div class="content-title-text">
                 ...
                 <table class="table table-clients">
                    ...
                    <?php
                        echo 'form enctype="multipart/form-data"  method="post" '.($data['config']['id']==1?'target="upload_target" class="ajax-file"':' class="ajax"').' action="/admin/ajax/editConfig">';
                        foreach($data['config'] as $config)
                        {
                            if(!empty($config['nazwa']))
                            {
                                ...
                                echo'  </td>  <td><button class="btn save">Zmień</button></td>
