...
//        $res3 = $adres->address($_SESSION['id']);
        ...
        $this->view('konto/index', ['menu'=>$res, 'user'=>$res2, 'notifications'=>$res4, 'configLogo'=>$configLogo, 'configPhone'=>$configPhone, 'configMail'=>$configMail] );
    }
    //'adres'=>$res3,
}