...
require_once 'ordersHistory.php';

class pdfModel extends OrdersHistory
{
        ...
        <body>
           <div class="container">
               ...
               <div class="orderNumber darkGreyColor">
                   ...
                   <div class="floatLeft half">
                       <h5 class="textRight fontSize12" style="margin-top: 5px;">Data zamówienia: '.$orderDetails['order_date'].'</h5>
                   </div>
               </div>
               ...
               <hr style="height: 2px; background: #8a95a1;">
